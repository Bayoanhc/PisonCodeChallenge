...
public class classiffierCodeChallenge {
	...
	public void classifier(String message, int data, JsonObject jsonParser, BufferedWriter bw) {
        ...
        //List to add all UNIQUE ACTIVATION data values
        ...
        if(listOfRealDataValues.contains(data)) {
        	...
        	switch(data) {
        		...
        		//This case SOMETIMES appear REST values
        		//INSERT NEW ALGORITHM HERE TO AVOID IT
        		...
        		case 80000:
		  		...
		  		//This case ALWAYS is ACTIVATION values
